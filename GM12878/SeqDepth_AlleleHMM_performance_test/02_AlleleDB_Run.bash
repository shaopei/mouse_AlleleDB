ln -s /workdir/sc2457/GM_GroSeq_AlleleDB_20170606/test_in_total/alleledb_strandSpecific_9.sh .
...
/workdir/sc2457/GM_GroSeq_AlleleDB_20170606/test_in_total/PIPELINE_StrandSpecific.mk \
0.1 \
ase \
